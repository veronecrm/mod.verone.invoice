...
<div class="page-header">
    <div class="page-header-content">
        <div class="page-title">
            <h1>
                ...
                <?php echo $invoice->getId() ? $app->t('invoiceEdit') : $app->t('invoiceNew'); ?><small> / {{ t('invoiceTypeProforma') }}</small>
            </h1>
        </div>
    ...
    <div class="breadcrumb-line">
        <ul class="breadcrumb">
            ...
            @if $invoice->getId()
                <li class="active"><a href="{{ createUrl('Invoice', 'ProformaInvoice', 'edit', [ 'id' => $invoice->getId() ]) }}">{{ t('invoiceEdit') }}</a></li>
            @else
                <li class="active"><a href="{{ createUrl('Invoice', 'ProformaInvoice', 'add') }}">{{ t('invoiceNew') }}</a></li>
            @endif
        </ul>
    </div>
</div>
...
<div class="container-fluid">
    <div class="row">
        <div class="col-md-12">
            <form action="{{ createUrl('Invoice', 'ProformaInvoice', $invoice->getId() ? 'update' : 'save') }}" method="post" id="form" class="form-validation">
                        ...
                        <div class="tabbable tabs-left">
                            ...
                            <div class="tab-content">
                                ...
                                <div class="step-out step-contractor">
                                    <div class="step-inn">
                                        <input type="hidden" id="contractorId" name="contractor" />
                                        <div class="container-fluid">
                                            <div class="row">
                                                <div class="col-md-12">
                                                        ...
                                                        <div class="row">
                                                            <div class="col-md-6">
                                                                <div class="form-group">
                                                                    ...
                                                                    <input class="form-control" type="text" id="buyerName" name="buyerName" value="{{ $invoice->getBuyerName() }}" />
                                                                </div>
                                                                <div class="form-group">
                                                                    <label for="buyerCity" class="control-label">{{ t('invoiceCity') }}</label>
                                                                    <input class="form-control" type="text" id="buyerCity" name="buyerCity" value="{{ $invoice->getBuyerCity() }}" />
                                                                </div>
                                                                <div class="form-group">
                                                                    <label for="buyerStreet" class="control-label">{{ t('invoiceStreet') }}</label>
                                                                    <input class="form-control" type="text" id="buyerStreet" name="buyerStreet" value="{{ $invoice->getBuyerStreet() }}" />
                                                                </div>
                                                            </div>
                                                            <div class="col-md-6">
                                                                <div class="form-group">
                                                                    <label for="buyerCountry" class="control-label">{{ t('invoiceCountry') }}</label>
                                                                    <input class="form-control" type="text" id="buyerCountry" name="buyerCountry" value="{{ $invoice->getBuyerCountry() }}" />
                                                                </div>
                                                                <div class="form-group">
                                                                    <label for="buyerPostCode" class="control-label">{{ t('invoicePostCode') }}</label>
                                                                    <input class="form-control" type="text" id="buyerPostCode" name="buyerPostCode" value="{{ $invoice->getBuyerPostCode() }}" />
                                                                </div>
                                                                <div class="form-group">
                                                                    <label for="buyerNIP" class="control-label">{{ t('invoiceNIP') }}</label>
                                                                    <input class="form-control" type="text" id="buyerNIP" name="buyerNIP" value="{{ $invoice->getBuyerNIP() }}" />
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>

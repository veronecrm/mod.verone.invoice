<div class="page-header">
    ...
    <div class="breadcrumb-line">
        <ul class="breadcrumb">
            ...
            <li class="active"><a href="{{ createUrl('Invoice', 'ProformaInvoice', 'summary', [ 'id' => $invoice->getId() ]) }}">{{ t('invoice') }} - {{ $invoice->getNumber() }}</a></li>
        </ul>
    </div>
</div>
                    ...
                    <div class="panel panel-default">
                        <div class="panel-body">
                            <div class="summary-panel">
                                ...
                                <span class="actions">
                                    <a href="{{ createUrl('Invoice', 'ProformaInvoice', 'edit', [ 'id' => $invoice->getId() ]) }}" class="btn btn-sm btn-default"><i class="fa fa-pencil"></i> {{ t('edit') }}</a>
                                </span>
